        ...
        <div className="text-center flex flex-col md:flex-row gap-16 pt-5">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-5 ">
            ...
            <div className=" flex flex-col justify-center items-center md:items-start ">
              ...
              <a href="mailto:abaysankar777@gmail.com" className={`flex gap-5 text-lg justify-start items-center hover:underline hover:text-[#147efb] text-gray-500 font-extrabold ${mulish.className}`}>
                abaysankar777@gmail.com</a>
            </div>
          </div>
        </div>
    </section>
