...
export const Hero: React.FC = () => {
  return (
    <>
      <main className="flex-col-reverse flex lg:gap-0 gap-10 lg:flex-row justify-center items-center lg:justify-between lg:items-center ">
        <section className=" flex flex-col justify-center items-center font-extrabold  lg:pt-5 w-full  ">
          <h1
        ...
        w-12/12 relative tracking-wide md:tracking-wider md:leading-tight"
          >
            ...
            <Image
              src={wave}
              className=" w-[18%] md:w-[4rem]   absolute lg:bottom-[34%] lg:right-[0rem] md:bottom-0 md:right-[3rem]   bottom-[35%] right-[4%] mx:bottom-0 mx:right-[2rem] "
              alt="hand"
            />
          </h1>
          <p
        ...
        <div>
          <Image
            src={abay}
            className={`${css.jellyImage} mx-auto lg:mx-0 w-[80%]  h-[54rem] rounded-full`}
